package com.datametica.cockatoos.output.writers.cassandra

import com.datametica.cockatoos.configuration.outputs.Cassandra
import com.datametica.cockatoos.output.writers.cassandra.CassandraOutputWriter.host
import com.datametica.cockatoos.output.{MetricOutputSession, MetricOutputWriter}
